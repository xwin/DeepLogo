  ...
  with graph.as_default():
    with tf.Session() as sess:
      ...
      for key in [
          ...
          'Squeeze','Postprocessor/convert_scores'
      ]:
        tensor_name = key + ':0'
      ...
      np.save("raw_detection_boxes.npy", output_dict['raw_detection_boxes'][0])
      np.save("raw_detection_scores.npy", output_dict['raw_detection_scores'][0])
      np.save("squeeze.npy", output_dict['Squeeze'][0])
      np.save("convert_scores.npy", output_dict['Postprocessor/convert_scores'][0])
